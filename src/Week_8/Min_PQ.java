 ...
 */
public class Min_PQ<Key> implements Iterable<Key> {
     ...
     */
    public Min_PQ(int initCapacity) {
     ...
     */
    public Min_PQ(int initCapacity, Comparator<Key> comparator) {
     ...
     * @param  comparator the order in which to compare the keys
     */
    public Min_PQ(Comparator<Key> comparator) {
        this(1, comparator);
    }
